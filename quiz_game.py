...
print('participa y descubre que tan idiota eres!')
...
answer = input('¿Cuál es el pais más extenso del mundo? ')
...
answer = input('¿Quién es el sapo hijueputa mas grande de Colombia? ')
